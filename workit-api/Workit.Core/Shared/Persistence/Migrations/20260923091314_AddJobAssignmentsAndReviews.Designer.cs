...
namespace Workit.Core.Shared.Persistence.Migrations
{
    ...
    [Migration("20260923091314_AddJobAssignmentsAndReviews")]
    partial class AddJobAssignmentsAndReviews
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Workit.Core.Hiring.Domain.JobAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Workit.Core.Reviews.Domain.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("JobAssignmentId", "ReviewerRole")
                        .IsUnique();
            ...
            modelBuilder.Entity("Workit.Core.Hiring.Domain.JobAssignment", b =>
                {
                    ...
                    b.HasOne("Workit.Core.JobOpenings.Domain.JobOpening", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Workit.Core.Reviews.Domain.Review", b =>
                {
                    b.HasOne("Workit.Core.Hiring.Domain.JobAssignment", null)
                        .WithMany()
