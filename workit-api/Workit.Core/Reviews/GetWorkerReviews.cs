...
/// <summary>Reviews a worker received from businesses after completed job assignments.</summary>
public static class GetWorkerReviews
{
    public sealed record Request(Guid WorkerProfileId, int Page = 1, int PageSize = 25)
    ...
    internal sealed class Handler(ReadAppDbContext db) : IRequestHandler<Request, Response>
    {
        public async Task<Response> Handle(Request request, CancellationToken cancellationToken)
        {
            ...
            var query =
                ...
                where assignment.WorkerProfileId == request.WorkerProfileId && review.ReviewerRole == ReviewerRole.Business
